...
export default async function TermsPage({ params }) {
  ...
  const blocks = dict.termsPage?.blocks ?? []
    ...
    <>
      ...
      <section style={{ background: '#3B5249', padding: 'clamp(100px,14vw,160px) clamp(18px,4vw,40px) clamp(48px,6vw,72px)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <h1 style={{ font: '400 clamp(36px,6vw,64px)/1.05 Cormorant Garamond,serif', color: '#fff', margin: '14px 0 0' }}>{t(dict, 'termsPage.title')}</h1>
